...
// ✅ Patch: Optional chaining + default values to fix pair code error
...
// ✅ Patch: safe fallback for group commands
export const DEFAULT_CONNECTION_CONFIG: SocketConfig = {
  ...
  countryCode: 'US',
  // ✅ Fallbacks for missing messages & group metadata
  getMessage: async (key) => ({ conversation: '', key }),
  cachedGroupMetadata: async (jid) => ({ id: jid, subject: '', participants: [], owner: '', desc: '' }),
